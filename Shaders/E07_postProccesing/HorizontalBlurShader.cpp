...
void HorizontalBlurShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX &worldMatrix, const XMMATRIX &viewMatrix, const XMMATRIX &projectionMatrix, ID3D11ShaderResourceView* texture, float width,int neigboursToCheck)
{
	HRESULT result;
	...
	widthPtr->neightRange = neigboursToCheck;
...
void HorizontalBlurShader::Render(ID3D11DeviceContext* deviceContext, int indexCount)
{
