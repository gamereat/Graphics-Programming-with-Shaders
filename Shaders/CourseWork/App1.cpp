...
void App1::init(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight, Input *in)
{
	...
	terrainShader = new TerrainGenerator(m_Direct3D->GetDevice(), hwnd);
	...
	terrainMesh = new PlaneMesh(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), L"../res/bunny.png");
...
void App1::RenderTerrain()
{
	...
	// Clear the render to texture.
	m_TerrainTexture->ClearRenderTarget(m_Direct3D->GetDeviceContext(), 0.0f, 0.0f, 1.0f, 1.0f);
