...
TessilatedShereMesh::TessilatedShereMesh(ID3D11Device* device, ID3D11DeviceContext* deviceContext, WCHAR* textureFilename, int resolution)
	:SphereMesh(device, deviceContext, textureFilename, resolution)
{
}


TessilatedShereMesh::~TessilatedShereMesh()
{
	BaseMesh::~BaseMesh();

}

void TessilatedShereMesh::InitBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
void TessilatedShereMesh::SendData(ID3D11DeviceContext * deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
void TessilatedShereMesh::MenuOptions(bool * is_open)
{
}
